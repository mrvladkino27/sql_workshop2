...
ALTER TABLE Manufacturer ADD CONSTRAINT PK_Manufactured PRIMARY KEY(company_name);
...
ADD CONSTRAINT FK_Manufactured_Model FOREIGN KEY (model_manufactured) REFERENCES Manufacturer (company_name);
ALTER TABLE Car
